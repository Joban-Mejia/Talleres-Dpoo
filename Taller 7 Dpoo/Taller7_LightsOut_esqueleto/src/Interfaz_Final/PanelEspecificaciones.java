...
private Inicio interfaz;
	...
	public PanelEspecificaciones(Inicio interfaz) {
        ...
        rBtnFacil.setBackground(Color.BLACK);
        rBtnFacil.setForeground(Color.WHITE);
        
        rBtnNormal.setBackground(Color.BLACK);
        rBtnNormal.setForeground(Color.WHITE);
        
        rBtnDificil.setBackground(Color.BLACK);
